...
typedef enum {
    ...
    BAR,  // barrier between phases
} InvType;

/* Coherence states for the MESI protocol */
typedef enum {
    I, // invalid
    L, // attempted to write and lost
    O, // Old shared value
    S, // shared (and clean)
    W, // attempted to write and won
    C, // exclusive and clean
    D  // exclusive and dirty
} DCWSOLIState;
