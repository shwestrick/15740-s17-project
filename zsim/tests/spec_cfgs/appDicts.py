...
class SPECApplication(Application):
    ...
    def getCommand(self, input):
        return self.envs["BENCH_DIR"] + self.suite + "/" + self.name + "/run/run_base_" + input + "_" + self.envs["SPEC_CFG"] + ".0000/" + self.s_name + "_base." + self.envs["SPEC_CFG"]
