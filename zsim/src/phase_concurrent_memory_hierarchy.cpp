...
static const char* dcwsoliStateNames[] = {"I", "L", "O", "S", "W", "C", "D"};
...
const char* DCWSOLIStateName(DCWSOLIState s) {
    assert_msg(s >= 0 && (size_t)s < sizeof(dcwsoliStateNames)/sizeof(const char*), "DCWSOLIStateName got an out-of-range input, %d", s);
    return dcwsoliStateNames[s];
}
