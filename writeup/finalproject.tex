...
\todo{Add explanations for transitions + proof of correctness}

\section{Simulations}
\todo{Fill in results here: hits + traffic from Charlie}

Using a homegrown simulator, we have verified the correctness of the DCWSOLI
protocol on two sample programs, summarized below. On both programs, we ran
the simulator with many different input sizes and number of processors.
\begin{itemize}
